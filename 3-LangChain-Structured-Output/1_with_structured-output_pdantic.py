...
# result = structured_model.invoke("""I’ve been using this serum for about three weeks and I can actually see my skin looking brighter. It absorbs fast and doesn’t feel sticky. The only downside is the citrus scent — it’s a bit strong for me in the morning. Still, great value for the price.""")
...
class AnnotationReview(BaseModel):
    key_themes: Annotated[list[str],Field(description="Write down all the key themes discussed in the review")]
    summary: Annotated[str, Field(description="A short 1-sentence summary of the review")]
    sentiment: Annotated[str, Field(description="Overall sentiment: positive, neutral, or negative")]
...
annotated_structured_model = model.with_structured_output(AnnotationReview)
